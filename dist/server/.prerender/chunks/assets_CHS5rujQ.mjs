...
import { E as LocalImageUsedWrongly, P as NoImageMetadata, Q as UnsupportedImageFormat, T as InvalidImageService, U as RemoteImageNotAllowed, Z as UnsupportedImageConversion, d as ExpectedImageOptions, f as ExpectedNotESMImage, j as MissingImageDimension, n as AstroError, p as FailedToFetchRemoteImageDimensions, t as shorthash, u as ExpectedImage, x as IncompatibleDescriptorOptions } from "./shorthash_8iE-JVc1.mjs";
import { d as joinPaths, h as removeQueryString, t as isRemoteAllowed, u as isRemotePath } from "./remote_43EHlu7o.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_CHY5BqD2.mjs").catch((e) => {
